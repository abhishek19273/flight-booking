  ...
  useEffect(() => {
    const fetchBookingDetails = async () => {
      ...
      try {
        ...
        // Format booking data to match component requirements
        setBooking({
          ...bookingData,
          flights: bookingData.flights.map((bf: any) => bf.flight)
        });
      } catch (error) {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="space-y-6">
          {booking.flights.map((flight, index) => (
            <Card key={flight.id} className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
              <CardHeader>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-4">
                      <div className="flex items-center space-x-2">
                        ...
                        <div>
                          <p className="font-semibold">{flight.origin_airport.iata_code}</p>
                          <p className="text-sm text-gray-600">{flight.origin_airport.city}</p>
                        </div>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        <MapPin className="h-4 w-4 text-gray-400" />
                        <div>
                          <p className="font-semibold">{flight.destination_airport.iata_code}</p>
                          <p className="text-sm text-gray-600">{flight.destination_airport.city}</p>
                        </div>
                      </div>
                    </div>
                  </div>
