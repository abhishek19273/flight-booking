...
const SignUpPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await signUp(email, password, firstName, lastName, phoneNumber || undefined);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-sky-50">
      ...
      <div className="flex min-h-[calc(100vh-64px)]">
          ...
          <div className="max-w-md w-full space-y-8">
            <div>
              ...
              <p className="mt-2 text-center text-sm text-gray-600">
                Join SkyBound and start your journey today
              </p>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-150"
                >
        ...
        <div className="hidden lg:block lg:w-1/2 relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1464037866556-6812c9d1c72e')] bg-cover bg-center"></div>
          <div className="absolute inset-0 flex flex-col justify-center items-center text-white p-12">
            <div className="max-w-md text-center">
              <h2 className="text-3xl font-bold mb-6">Start Your Journey Today</h2>
              <p className="text-lg mb-8">Join thousands of travelers who trust SkyBound Journeys for their flight booking needs.</p>
